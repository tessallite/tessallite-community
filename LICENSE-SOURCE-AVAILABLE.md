...
The source-available license applies only to files intentionally published in
the public Tessallite Community repository and not marked with another license.
...
- Tessallite trademarks, logos, brand assets, domain names, and product marks.

If a file has its own license header or is listed in `THIRD_PARTY_NOTICES.md`,
that more specific notice controls for that file or third-party component.
