 ...
 */
export declare function resolveWriteTarget(targetCell?: string): Promise<PinnedWriteTarget | null>;
/**
 ...
 */
export declare function withPinnedCellWrite<T>(target: PinnedWriteTarget, size: {
    rowCount: number;
    colCount: number;
}, body: (ctx: PinnedWriteContext) => Promise<T>, options?: {
    timeoutMs?: number;
