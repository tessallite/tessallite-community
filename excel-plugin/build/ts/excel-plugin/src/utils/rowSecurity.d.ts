...
export declare const ROW_SECURITY_DENY_ALL_RULE_ID = "__deny_all__";
export declare function securityRulesApplied(response: {
    security_rules_applied?: unknown;
} | null | undefined): string[];
/** True when row security denied the caller every row. */
export declare function rowSecurityDeniedAll(response: {
    security_rules_applied?: unknown;
