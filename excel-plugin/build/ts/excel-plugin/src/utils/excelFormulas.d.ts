 ...
 */
export declare const TESSALLITE_CONNECTION_NAME = "Tessallite";
/**
 ...
 */
export declare function buildXmlaCatalogName(modelSlug: string, personaSlug?: string | null): string;
export declare function escapeExcelString(value: string): string;
/**
 * Escape a name for use inside MDX brackets: ']' -> ']]'.
 * Example: escapeMdxBracketContent("Revenue]Total") -> "Revenue]]Total"
 */
export declare function escapeMdxBracketContent(name: string): string;
/** @deprecated Use escapeMdxBracketContent instead */
export declare const escapeMdxIdentifier: typeof escapeMdxBracketContent;
/**
 * Produce a fully-qualified MDX member reference: [Dimension].[Hierarchy].[Member]
 */
export declare function qualifyMdxMember(dimension: string, hierarchy: string, member: string): string;
/**
 ...
 */
export declare function measureMemberRef(measureName: string): string;
/**
 ...
 */
export declare function dimensionMemberRef(dimensionName: string, memberKey: string): string;
/**
 * Generate a CUBEMEMBER formula.
 */
export declare function generateCubeMember(connectionName: string, memberExpression: string): string;
/**
 * Generate a CUBEVALUE formula.
 */
export declare function generateCubeValue(connectionName: string, measureExpression: string, filterExpressions?: string[]): string;
/**
 * Generate a CUBESET formula.
 */
export declare function generateCubeSet(connectionName: string, setExpression: string, caption?: string): string;
/**
 * Generate a CUBERANKEDMEMBER formula.
 * Returns the Nth member from a set defined by a CUBESET formula.
 */
export declare function buildCubeRankedMemberFormula(connectionName: string, setCellRef: string, rank: number): string;
export type CubeKpiProperty = 1 | 2 | 3 | 4 | 5;
export declare const CUBE_KPI_PROPERTIES: Record<string, CubeKpiProperty>;
/**
 ...
 */
export declare function buildCubeKpiFormula(connectionName: string, kpiName: string, property: CubeKpiProperty): string;
/**
 ...
 */
export declare function buildCubeKpiValueFormula(connectionName: string, kpiName: string, property: CubeKpiProperty): string;
/**
 ...
 */
export declare function kpiValueCellFormula(connectionName: string, kpiTechnicalName: string, valueMeasureName: string | null): string;
/**
 ...
 */
export declare function kpiStatusCellFormula(connectionName: string, kpiTechnicalName: string): string;
/**
 ...
 */
export declare function buildMsolapConnectionString(serverUrl: string, catalog: string, username?: string): string;
