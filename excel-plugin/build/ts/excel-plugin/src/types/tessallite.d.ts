...
export type FieldCompatibilityReasonCode = 'NO_JOIN_PATH' | 'AMBIGUOUS_JOIN_PATH' | 'MANY_TO_MANY_UNSUPPORTED' | 'AGGREGATE_GRAIN_MISMATCH' | 'MEASURE_DEPENDENCY_UNREACHABLE' | 'PERSONA_FIELD_UNAVAILABLE' | 'HIDDEN_FIELD_UNAVAILABLE' | 'UNKNOWN_FIELD' | 'SEMANTIC_COMPATIBILITY_NOT_ANALYZED';
