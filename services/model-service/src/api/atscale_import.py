...
async def import_atscale_sml(
    ...
    if dry_run:
        return AtScaleImportResponse(
            ...
            warnings=normalize_import_warnings(result.warnings, source="atscale"),
    ...
    async for db in get_tenant_db(current_user.tenant_id):
        ...
        placeholder_conn = ProjectConnection(
            ...
            display_name="(atscale import — configure me)",
        ...
        result.warnings.append(
            make_import_warning(
                code="atscale.connection_placeholder",
        ...
        for model_snap in result.bundle.get("models", []):
            ...
            try:
                ...
                raise HTTPException(
                    ...
                    detail=f"Invalid model slug in AtScale import: {exc}",
                ) from exc
