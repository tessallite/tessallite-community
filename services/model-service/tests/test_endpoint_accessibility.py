...
# Routes that legitimately require real infrastructure (Alembic subprocess,
# Fernet key, real DB commit+refresh cycle) and cannot run with mocks.
_INFRA_ROUTES: set[str] = {
    "POST /api/v1/admin/migrate/system",
    "POST /api/v1/projects/{project_id}/export",
    "POST /api/v1/projects/{project_id}/models/{model_id}/aggregates/{agg_id}/refresh/policy",
}
