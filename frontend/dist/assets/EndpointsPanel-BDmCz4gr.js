import{r as f,j as e}from"./react-vendor-GPNyayNe.js";import{u as y,s as B,a7 as c,ab as Y}from"./index-CIEGKv5B.js";import{a1 as T,b5 as U,bc as G,bd as W,ay as O}from"./mui-icons-DPt6eVWQ.js";import{p as X}from"./hooks-BU291u4u.js";import{b as J}from"./react-router-Bvj3z2RT.js";import{B as i,d as a,h as I,a9 as S,aa as $,Y as x,ab as w,t as A,G as E,H as b,T as M,I as V,o as R,m as N}from"./mui-core-c43Yv0-7.js";import"./vendor-B2zYrXBr.js";import"./react-query-DtnFmsmi.js";function Q(){return typeof window>"u"?"localhost":window.location.hostname||"localhost"}function K(){return typeof window>"u"?"http:":window.location.protocol||"http:"}function L(s,n,o){const t=typeof window<"u"?B(s,""):"";return t.trim()?t.trim():n??o}const D=Q(),z=K(),P=Y().endpointDefaults,H=L("builder.settings.queryRouterUrl",void 0,`${z}//${D}:${P.query_router_port}`),k=L("builder.settings.gatewayHttpUrl",void 0,`${z}//${D}:${P.gateway_http_port}`),C=L("builder.settings.gatewayJdbcHost",void 0,D),v=L("builder.settings.gatewayJdbcPort",void 0,String(P.gateway_jdbc_port));function g({code:s}){const n=y(),[o,t]=f.useState(!1);function r(){navigator.clipboard.writeText(s).then(()=>{t(!0),setTimeout(()=>t(!1),1800)})}return e.jsxs(i,{sx:{position:"relative"},children:[e.jsx(i,{component:"pre",sx:{m:0,p:1.5,pr:5,bgcolor:"grey.900",color:"grey.100",borderRadius:1,fontSize:"0.72rem",fontFamily:"monospace",whiteSpace:"pre-wrap",wordBreak:"break-all",overflowX:"auto"},children:s}),e.jsx(M,{title:n(o?"endpoints.copiedToClipboard":"common.copy"),children:e.jsx(V,{size:"small",onClick:r,sx:{position:"absolute",top:4,right:4,color:o?"success.light":"grey.400","&:hover":{color:"grey.100"}},children:o?e.jsx(G,{fontSize:"small"}):e.jsx(W,{fontSize:"small"})})})]})}function Z({modelId:s,modelSlug:n,tenantSlug:o}){const t=y(),[r,m]=f.useState(0),l=`${H}/api/v1`,p=`curl -X POST "${l}/execute" \\
