import{r as T,j as e}from"./react-vendor-DnqIm-AP.js";import{u as v,D as J,ae as Q,s as z,aK as a,aW as X}from"./index-Dr5KXuOR.js";import{a9 as w,bc as E,aF as k,n as K,o as Z}from"./mui-icons-BtPQbDeZ.js";import{b as ee}from"./react-router-DiXDWuun.js";import{B as i,a as l,n as b,ae as I,af as _,C as c,ag as D,v as L,N as U,O as g,q as B,o as ne,T as se,I as te}from"./mui-core-CNvpAdyL.js";import"./vendor-DLE_IJkN.js";import"./react-query-BZDDqXdG.js";function oe(){return typeof window>"u"?"localhost":window.location.hostname||"localhost"}function ie(){return typeof window>"u"?"http:":window.location.protocol||"http:"}function W(n,s,o){const t=typeof window<"u"?z(n,""):"";return t.trim()?t.trim():s??o}function re(n){return n==="localhost"||n==="127.0.0.1"||n==="0.0.0.0"||n==="::1"||n==="[::1]"||n.endsWith(".local")||n.endsWith(".localhost")}function M(n,s,o,t){const r=typeof window<"u"?z(n,""):"";return r.trim()?{value:r.trim(),reliable:!0}:{value:o,reliable:t}}const P=oe(),H=ie(),G=re(P),A=X().endpointDefaults,R=W("builder.settings.queryRouterUrl",void 0,`${H}//${P}:${A.query_router_port}`),V=M("builder.settings.gatewayHttpUrl",void 0,`${H}//${P}:${A.gateway_http_port}`,G),q=M("builder.settings.gatewayJdbcHost",void 0,P,G),F=V.value,S=q.value,ae=V.reliable&&q.reliable,j=W("builder.settings.gatewayJdbcPort",void 0,String(A.gateway_jdbc_port));function h({code:n}){const s=v(),[o,t]=T.useState(!1);function r(){navigator.clipboard.writeText(n).then(()=>{t(!0),setTimeout(()=>t(!1),1800)})}return e.jsxs(i,{sx:{position:"relative"},children:[e.jsx(i,{component:"pre",sx:{m:0,p:1.5,pr:5,bgcolor:"grey.900",color:"grey.100",borderRadius:1,fontSize:"0.72rem",fontFamily:"monospace",whiteSpace:"pre-wrap",wordBreak:"break-all",overflowX:"auto"},children:n}),e.jsx(se,{title:s(o?"endpoints.copiedToClipboard":"common.copy"),children:e.jsx(te,{size:"small",onClick:r,sx:{position:"absolute",top:4,right:4,color:o?"success.light":"grey.400","&:hover":{color:"grey.100"}},children:o?e.jsx(K,{fontSize:"small"}):e.jsx(Z,{fontSize:"small"})})})]})}function N(){const n=v();return ae?null:e.jsx(b,{severity:"warning",sx:{mb:1.5,py:.5},children:n("endpoints.gatewayAddressUnverified")})}function le(n,s,o){return s?`${n}/${s}/${o}`:`${n}/${o}`}function ce({modelId:n,modelSlug:s,tenantSlug:o}){const t=v(),[r,p]=T.useState(0),d=`${R}/api/v1`,m=`curl -X POST "${d}/execute" \\
