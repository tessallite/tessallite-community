import{r as T,j as e}from"./react-vendor-DnqIm-AP.js";import{u as v,C as J,ae as Q,s as z,aK as a,aW as X}from"./index-x0K30Nia.js";import{aa as w,bd as C,aG as k,o as K,p as Z}from"./mui-icons-REBqqxL_.js";import{b as ee}from"./react-router-BJbdiX_o.js";import{B as i,a as l,j as b,ae as I,af as _,C as c,ag as D,v as E,N as U,O as g,q as B,o as ne,T as se,I as te}from"./mui-core-BDSG32EC.js";import"./vendor-BFYrPwbP.js";import"./react-query-Cl4fm_Sr.js";function oe(){return typeof window>"u"?"localhost":window.location.hostname||"localhost"}function ie(){return typeof window>"u"?"http:":window.location.protocol||"http:"}function W(n,s,o){const t=typeof window<"u"?z(n,""):"";return t.trim()?t.trim():s??o}function re(n){return n==="localhost"||n==="127.0.0.1"||n==="0.0.0.0"||n==="::1"||n==="[::1]"||n.endsWith(".local")||n.endsWith(".localhost")}function G(n,s,o,t){const r=typeof window<"u"?z(n,""):"";return r.trim()?{value:r.trim(),reliable:!0}:{value:o,reliable:t}}const L=oe(),H=ie(),M=re(L),A=X().endpointDefaults,R=W("builder.settings.queryRouterUrl",void 0,`${H}//${L}:${A.query_router_port}`),V=G("builder.settings.gatewayHttpUrl",void 0,`${H}//${L}:${A.gateway_http_port}`,M),q=G("builder.settings.gatewayJdbcHost",void 0,L,M),F=V.value,S=q.value,ae=V.reliable&&q.reliable,j=W("builder.settings.gatewayJdbcPort",void 0,String(A.gateway_jdbc_port));function h({code:n}){const s=v(),[o,t]=T.useState(!1);function r(){navigator.clipboard.writeText(n).then(()=>{t(!0),setTimeout(()=>t(!1),1800)})}return e.jsxs(i,{sx:{position:"relative"},children:[e.jsx(i,{component:"pre",sx:{m:0,p:1.5,pr:5,bgcolor:"grey.900",color:"grey.100",borderRadius:1,fontSize:"0.72rem",fontFamily:"monospace",whiteSpace:"pre-wrap",wordBreak:"break-all",overflowX:"auto"},children:n}),e.jsx(se,{title:s(o?"endpoints.copiedToClipboard":"common.copy"),children:e.jsx(te,{size:"small",onClick:r,sx:{position:"absolute",top:4,right:4,color:o?"success.light":"grey.400","&:hover":{color:"grey.100"}},children:o?e.jsx(K,{fontSize:"small"}):e.jsx(Z,{fontSize:"small"})})})]})}function N(){const n=v();return ae?null:e.jsx(b,{severity:"warning",sx:{mb:1.5,py:.5},children:n("endpoints.gatewayAddressUnverified")})}function le(n,s,o){return s?`${n}/${s}/${o}`:`${n}/${o}`}function ce({modelId:n,modelSlug:s,tenantSlug:o}){const t=v(),[r,p]=T.useState(0),d=`${R}/api/v1`,m=`curl -X POST "${d}/execute" \\
...
</OfficeApp>`}function ue({tenantSlug:n}){const s=v(),o=`${H}//${L}:${A.model_service_port}`,t=R.replace(/\/api\/v1$/,""),r=`{
  "mcpServers": {
    "tessallite": {
